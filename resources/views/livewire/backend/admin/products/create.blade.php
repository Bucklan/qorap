                ...
                <div class="card mb-4">
                    <div class="card-body">
                        ...
                        @foreach($categories as $category)
                            @if(!$category->parent_id)
                                <div class="form-check">
                                    <input class="form-check-input" wire:model="productCategories" value="{{$category->id}}" type="checkbox" id="category_{{$category->id}}" />
                                    <label for="category_{{$category->id}}">{{$category->name}}</label>
                                </div>
                                @foreach($category->children as $child)
                                    <div class="form-check ml-4">
                                        <input class="form-check-input" wire:model="productCategories" value="{{$child->id}}" type="checkbox" id="category_{{$child->id}}" />
                        ...
                        @foreach($colors as $color)
                            <div class="form-check">
                                <input class="form-check-input" wire:model="productColors" type="checkbox" value="{{$color->id}}" id="{{$color->id}}" />
